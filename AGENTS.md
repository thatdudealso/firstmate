...
data/                personal fleet records; LOCAL, gitignored as a whole
  ...
  crewboard-fleet/   optional crew board for tickets and messages; bin/fm-board.sh owns access (section 7)
...
The verified harnesses are `claude`, `codex`, `opencode`, `pi`, `pi-signed`, `grok`, `kimi`, and `vibe`; Vibe is verified for crewmate and scout dispatch only, and no adapter may be dispatched outside its verified scope.
