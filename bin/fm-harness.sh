...
# Usage: fm-harness.sh                  print own harness: claude|codex|opencode|pi|pi-signed|grok|kimi|vibe|unknown
...
detect_own() {
  ...
  # kimi, and vibe are markerless, so a foreign marker retained in a terminal
      ...
      *grok*) echo grok; return ;;
      ...
      node*|python*|Node*|Python*)
        ...
        case "$args" in
          ...
          *opencode*) echo opencode; return ;;
          *grok*) echo grok; return ;;
          *[[:space:]]*/vibe[[:space:]]*|*/vibe) echo vibe; return ;;
